...
var author$project$BootstrappedSignup$initialModel = {email: '', loggedIn: false, name: '', password: ''};
...
var author$project$BootstrappedSignup$view = function (user) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$BootstrappedSignup$main = author$project$BootstrappedSignup$view(author$project$BootstrappedSignup$initialModel);
_Platform_export({'BootstrappedSignup':{'init':_VirtualDom_init(author$project$BootstrappedSignup$main)(0)(0)}});}(this));